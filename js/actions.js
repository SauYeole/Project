...
function page_content_onresize() {
  ...
  var content_minus = 0;
  content_minus = $(".page-container").length > 0 ? 40 : content_minus;
  ...
  if ($(window).width() > 1024) {
    if ($(".page-sidebar").hasClass("scroll")) {
      if ($("body").hasClass("page-container")) {
  ...
  if ($(window).width() < 1200) {
    if ($("body").hasClass("page-container")) {
      $("body").removeClass("page-container").data("boxed", "1");
    }
  } else {
    if ($("body").data("boxed") === "1") {
      $("body").addClass("page-container").data("boxed", "");
    }
  }
}
