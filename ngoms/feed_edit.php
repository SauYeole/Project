                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="feed_edit_sub.php">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add</strong> Feedback</h3>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="feed_name" value="<?php echo $feed_name; ?>" class="form-control"/>
                                                    </div>                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">                                            
                                                    ...
                                                    <span class="help-block">Enter Description of feedback</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Date of Feedback</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" name="feed_date" value="<?php echo $feed_date; ?>" class="form-control datepicker">                                            
                                                    </div>
                                                    <span class="help-block">Select Date of Feedback</span>
                                                </div>
                                            </div>
