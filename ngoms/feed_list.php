                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="feed_view.php?id=<?php echo $id; ?>" class="btn btn-info">View</a>
                                                    <a href="feed_edit.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="feed_del.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
