                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sel=mysqli_query($conn,"SELECT * FROM add_beni");
                                            ...
                                            <tr>
                                                <td><?php echo $id; ?></td>
                                                <td><?php echo $don_name; ?></td>
                                                <td><?php echo $don_addr; ?></td>
                                                <td><?php echo $don_mob; ?></td>
                                                <td><?php echo $dona_amt; ?></td>

                                                <td>
                                                    <a href="beni_view.php?id=<?php echo $id; ?>" class="btn btn-info">View</a>
                                                    <a href="beni_edit.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="beni_del.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
