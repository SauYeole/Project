                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sel=mysqli_query($conn, "SELECT * FROM add_emp");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $emp_desi; ?></td>
                                                <td>
                                                    <a href="emp_view.php?id=<?php echo $id; ?>" class="btn btn-info">View</a>
                                                    <a href="emp_edit.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="emp_del.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
