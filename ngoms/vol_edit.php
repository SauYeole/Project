                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form class="form-horizontal" method="POST" action="vol_edit_sub.php">
                                ...
                                <div class="panel-body">                                                  
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input name="vol_name" value="<?php echo $vol_name; ?>" type="text" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <textarea class="form-control" name="vol_add"><?php echo $vol_add; ?></textarea>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input name="vol_contact" value="<?php echo $vol_contact; ?>" type="number" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input name="vol_occu" value="<?php echo $vol_occu; ?>" type="text" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input name="vol_intr_wrk" value="<?php echo $vol_intr_wrk; ?>" type="text" class="form-control"/>
                                            </div>                                            
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group col-md-12">
                                                 ...
                                                 <div class="col-md-4">
                                                    <select class="form-control select" name="doj_day">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select" name="doj_month">
                                                        <option value="01">01</option>
                                                        <option value="02">02</option>
                                                        <option value="03">03</option>
                                                        <option value="04">04</option>
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select" name="doj_yr">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group col-md-12">
                                                 ...
                                                 <div class="col-md-4">
                                                    <select class="form-control select" name="dob_day">
                                                        <option value="01">01</option>
                                                        <option value="02">02</option>
                                                        <option value="03">03</option>
                                                        <option value="04">04</option>
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select" name="dob_month">
                                                        <option value="01">01</option>
                                                        <option value="02">02</option>
                                                        <option value="03">03</option>
                                                        <option value="04">04</option>
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select" name="dob_yr">
