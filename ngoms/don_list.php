                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="don_view.php?id=<?php echo $id; ?>" class="btn btn-info">View</a>
                                                    <a href="don_edit.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="don_del.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
