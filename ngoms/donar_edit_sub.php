<?php
	...
	if (isset($_POST['save']))
	{
		...
		$upd=mysql_query("UPDATE add_donar SET don_name='$don_name',don_addr='$don_addr',don_mob='$don_mob',don_email='$don_email',don_dob='$don_dob',dona_type='$dona_type',dona_amt='$dona_amt',dona_date='$dona_date' WHERE don_id='$don_id'");
