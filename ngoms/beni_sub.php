<?php 
	...
	if (isset($_POST['save']))
	{
		...
		$ins=mysqli_query($conn,"INSERT INTO add_beni(don_name,don_addr,don_mob,don_email,don_dob,dona_type,dona_amt,dona_date) VALUES('$don_name','$don_addr','$don_mob','$don_email','$don_dob','$dona_type','$dona_amt','$dona_date')");
