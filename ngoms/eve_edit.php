                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form class="form-horizontal" method="POST" action="eve_edit_sub.php">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add </strong> Event</h3>
                                    
                                </div>
                                <input type="hidden" value="<?php echo $eve_id; ?>" name="eve_id">
                                <div class="panel-body">                                                  
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input name="event_name" value="<?php echo $event_name; ?>" type="text" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <textarea class="form-control" name="evnt_desc"> <?php echo $evnt_desc; ?></textarea>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input name="event_coord" value="<?php echo $event_coord; ?>" type="text" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input name="coord_mob" value="<?php echo $coord_mob; ?>" type="number" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <textarea class="form-control" name="evnt_addre"> <?php echo $evnt_addre; ?></textarea>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input name="evnt_fund" value="<?php echo $evnt_fund; ?>" type="number" class="form-control"/>
                                            </div>                                            
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group col-md-12">
                                                 ...
                                                 <div class="col-md-4">
                                                    <select class="form-control select" value="<?php echo $evnt_day; ?>" name="evnt_day">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select" value="<?php echo $evnt_mnth; ?>" name="evnt_mnth">
                                                        <option value="01">01</option>
                                                        <option value="02">02</option>
                                                        <option value="03">03</option>
                                                        <option value="04">04</option>
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select" value="<?php echo $evnt_yr; ?>" name="evnt_yr">
