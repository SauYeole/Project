                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $id; ?></td>
                                                <td><?php echo $exp_for; ?></td>
                                                <td><?php echo $exp_by; ?></td>
                                                <td><?php echo $exp_amt; ?></td>
                                                <td><?php echo $exp_date; ?></td>

                                                <td>
                                                    <a href="exp_view.php?id=<?php echo $id; ?>" class="btn btn-info">View</a>
                                                    <a href="exp_edit.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="exp_del.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
