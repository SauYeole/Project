<?php 
    ...
    $sel=mysqli_query($conn,"SELECT * FROM add_donar WHERE don_id='$id'");
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="donar_edit_sub.php">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="don_name" value="<?php echo $don_name; ?>" class="form-control"/>
                                                    </div>                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">                                            
                                                    <textarea class="form-control" name="don_addr" rows="5"><?php echo $don_addr; ?></textarea>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" name="don_mob" value="<?php echo $don_mob; ?>" class="form-control"/>
                                                    </div>            
                                             ...
                                             <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                        <input type="email" name="don_email" value="<?php echo $don_email; ?>" class="form-control"/>
                                                    </div>            
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="don_dob" value="<?php echo $don_dob; ?>" class="form-control datepicker">                                            
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="dona_type" value="<?php echo $dona_type; ?>">
                                             ...
                                             <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                        <input type="number" name="dona_amt" value="<?php echo $dona_amt; ?>" class="form-control"/>
                                                    </div>            
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" name="dona_date" value="<?php echo $dona_date; ?>" class="form-control datepicker">                                            
                                                    </div>
