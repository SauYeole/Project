                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $vol_contact; ?></td>
                                                <td><?php echo $vol_occu; ?></td>
                                                <td><?php echo $vol_intr_wrk; ?></td>

                                                <td>
                                                    <a href="vol_view.php?id=<?php echo $id; ?>" class="btn btn-info">View</a>
                                                    <a href="vol_edit.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="vol_del.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
